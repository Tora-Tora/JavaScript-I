...
// Apparently I overthink it in trying to keep the interns organized. Ugh fine I will do an object for EACH.AND.EVERY.SINGLE.INTERN
// const intern = [
...
const Mitzi = {id: 1, name: "Mitzi", email: "mmelloy0@PushSubscription.edu", gender: "F"};
const Kennan = {id: 2, name: "Kennan", email: "kdiben1@tinypic.com", gender: "M", speak: function(){return "Hello, my name is Kennan!";}};
...
const Antonietta = {id: 5, name: "Antonietta", email: "adaine5@samsung.com", gender: "F", multiplyNums: function(num1,num2){return num1*num2;}};
...
const parent = {
  name: "Susan",
  age: 70,
  //hmmm writing speak as arrow function make this.name not work
